...
function App() {
  ...
  var getStory = () => {
    debugger;
    axios.get("https://cors-anywhere.herokuapp.com/http://localhost:3307/story").then((res, rej) => {
      debugger;
      if (res) {
  ...
  var getProduct = () => {
    axios.get("https://cors-anywhere.herokuapp.com/http://localhost:3307/products").then((res, rej) => {
      if (res) {
        debugger;
